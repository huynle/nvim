...
_G.packer_plugins = {
  ...
  ["nvim-bqf"] = {
    after = { "fzf.vim" },
    config = { "\27LJ\2\nç\2\0\0\4\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\0025\3\6\0=\3\a\2B\0\2\1K\0\1\0\rfunc_map\1\0\t\btab\ast\nsplit\asg\vsclear\r<space>c\fffilter\r<space>F\vfilter\r<space>f\14stogglevm\f<space>\16stoggledown\f<space>\16ptoggleitem\6p\vvsplit\asv\fpreview\1\0\1\17auto_preview\2\1\0\2\16auto_enable\2\23auto_resize_height\1\nsetup\bbqf\frequire\0" },
    loaded = false,
    needs_bufread = true,
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-python", "nvim-dap-ui", "nvim-dap-virtual-text" },
  ...
  ["scratch.vim"] = {
    config = { "\27LJ\2\n:\0\0\2\0\3\0\0056\0\0\0009\0\1\0)\1\1\0=\1\2\0K\0\1\0\29scratch_persistence_file\6g\bvim\0" },
    loaded = true,
    path = "/home/e367212/.local/share/nvim/site/pack/packer/start/scratch.vim"
  },
  ["symbols-outline.nvim"] = {
    commands = { "SymbolsOutline", "SymbolsOutlineOpen", "SymbolsOutlineClose" },
    config = { "\27LJ\2\nç\2\0\0\4\0\a\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\0024\3\0\0=\3\6\2B\0\2\1K\0\1\0\18lsp_blacklist\fkeymaps\1\0\6\nclose\n<Esc>\17code_actions\6a\18rename_symbol\6r\17hover_symbol\6p\19focus_location\6o\18goto_location\t<CR>\1\0\4\rposition\nright\17auto_preview\1\16show_guides\2\27highlight_hovered_item\2\nsetup\20symbols-outline\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
-- Config for: scratch.vim
time([[Config for scratch.vim]], true)
try_loadstring("\27LJ\2\n:\0\0\2\0\3\0\0056\0\0\0009\0\1\0)\1\1\0=\1\2\0K\0\1\0\29scratch_persistence_file\6g\bvim\0", "config", "scratch.vim")
time([[Config for scratch.vim]], false)
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'editorconfig-vim', 'vim-sonictemplate'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'editorconfig-vim', 'vim-sonictemplate'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-sonictemplate'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'editorconfig-vim', 'vim-sonictemplate'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType vim ++once lua require("packer.load")({'editorconfig-vim', 'vim-sonictemplate'}, { ft = "vim" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType puppet ++once lua require("packer.load")({'vim-puppet', 'editorconfig-vim'}, { ft = "puppet" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'editorconfig-vim'}, { ft = "c" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'editorconfig-vim', 'vim-sonictemplate'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-operator-surround', 'indent-blankline.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'prodoc.nvim', 'vim-cursorword', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
